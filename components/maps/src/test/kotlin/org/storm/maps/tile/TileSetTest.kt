...
class TileSetTest : Application() {
    ...
    override fun start(primaryStage: Stage) {
        ...
        runBlocking {
            window.canvas.drawImageWithPixels(tileSet.tile(0), 100.0, 50.0)
            window.canvas.drawImageWithPixels(tileSet.tile(1), 150.0, 100.0)
            window.canvas.drawImageWithPixels(tileSet.tile(2), 200.0, 150.0)
        }
